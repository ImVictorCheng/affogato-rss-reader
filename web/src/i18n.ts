...
const messages = {
  en: {
    ...
    refreshSource: "Refresh source", refreshAll: "Refresh all", showAll: "Show all", unreadOnly: "Unread only", markAllRead: "Mark all read",
  ...
  "zh-CN": {
    ...
    refreshSource: "刷新本订阅源", refreshAll: "全部刷新", showAll: "显示全部", unreadOnly: "只显示未读", markAllRead: "全部标为已读",
